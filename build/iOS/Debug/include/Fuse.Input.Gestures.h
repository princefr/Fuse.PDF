...
struct Gestures : uObject
{
    ...
    static bool& _changePosted() { return Gestures_typeof()->Init(), _changePosted_; }
    ...
    static uSStrong< ::g::Fuse::Input::PointerEventArgs*>& _pumpArgs() { return Gestures_typeof()->Init(), _pumpArgs_; }
