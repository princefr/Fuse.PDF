...
##else
    open -aXcode "pdf.xcodeproj"
##endif
    exit $?
    ;;
uninstall)
    echo "Uninstalling com.apps.pdf"
    "/usr/local/share/uno/Packages/UnoCore/1.2.2/prebuilt/iOS/bin/ios-deploy" -9 -1 "com.apps.pdf"
    exit $?
    ;;
esac
...
##else
"/usr/local/share/uno/Packages/UnoCore/1.2.2/prebuilt/iOS/bin/ios-deploy" --noninteractive --debug --bundle "build/Debug-iphoneos/pdf.app" "$@"
##endif
