...
{
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL);
    ::TYPES[2] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Internal::PatchItem_typeof(), NULL);
    ::TYPES[4] = ::g::Uno::Collections::IList_typeof();
    ...
    type->SetFields(0,
        ...
        ::TYPES[4/*Uno.Collections.IList`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Reactive::Internal::SimpleAlgorithm, _from), 0,
        ::TYPES[1/*Uno.Collections.List<Fuse.Reactive.Internal.PatchItem>*/], offsetof(::g::Fuse::Reactive::Internal::SimpleAlgorithm, _ops), 0,
        ::TYPES[4/*Uno.Collections.IList`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Reactive::Internal::SimpleAlgorithm, _to), 0,
        ::TYPES[5/*Uno.Collections.Dictionary`2*/]->MakeType(type->T(0), ::g::Uno::Int_typeof(), NULL), offsetof(::g::Fuse::Reactive::Internal::SimpleAlgorithm, _toIndex), 0,
        ::TYPES[3/*Uno.Collections.List<bool>*/], offsetof(::g::Fuse::Reactive::Internal::SimpleAlgorithm, _toUsed), 0);
}
...
void SimpleAlgorithm__ctor__fn(SimpleAlgorithm* __this, uObject* from, uObject* to, void* emptyKey)
{
    ...
    __this->_toUsed = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[3/*Uno.Collections.List<bool>*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(to), __types[0]))));
