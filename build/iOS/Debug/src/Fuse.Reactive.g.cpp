...
#include <Fuse.Reactive.SimpleVarArgFunction.Subscription.h>
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    if (::g::Fuse::Reactive::IEventRecord::Node(uInterface(uPtr(_e), ::TYPES[7/*Fuse.Reactive.IEventRecord*/])) != NULL)
        uPtr(obj)->Item(::STRINGS[1/*"node"*/], uPtr(::g::Fuse::Reactive::JavaScript::Worker())->Unwrap(::g::Fuse::Reactive::IEventRecord::Node(uInterface(uPtr(_e), ::TYPES[7/*Fuse.Reactive.IEventRecord*/]))));

    if (::g::Fuse::Reactive::IEventRecord::Data(uInterface(uPtr(_e), ::TYPES[7/*Fuse.Reactive.IEventRecord*/])) != NULL)
        uPtr(obj)->Item(::STRINGS[2/*"data"*/], uPtr(::g::Fuse::Reactive::JavaScript::Worker())->Unwrap(::g::Fuse::Reactive::IEventRecord::Data(uInterface(uPtr(_e), ::TYPES[7/*Fuse.Reactive.IEventRecord*/]))));
    ...
    if (::g::Uno::String::op_Inequality(::g::Uno::UX::Selector__op_Implicit1(::g::Fuse::Reactive::IEventRecord::Sender(uInterface(uPtr(_e), ::TYPES[7/*Fuse.Reactive.IEventRecord*/]))), NULL))
        uPtr(obj)->Item(::STRINGS[3/*"sender"*/], uBox(::TYPES[33/*Uno.UX.Selector*/], ::g::Fuse::Reactive::IEventRecord::Sender(uInterface(uPtr(_e), ::TYPES[7/*Fuse.Reactive.IEventRecord*/]))));
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[12/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[4/*"JavaScript ...*/], ex, this, ::STRINGS[5/*"/usr/local/...*/], 234, ::STRINGS[6/*"Call"*/]);
        }
        else throw __t;
    }
}
...
void Clamp__Compute_fn(Clamp* __this, uObject* a, uObject* mn, uObject* mx, uObject** __retval)
{
    ...
    if (size == 2)
        return *__retval = uBox(::TYPES[96/*float2*/], ::g::Uno::Math::Clamp2(::g::Uno::Float2__New2(av.X, av.Y), mnv, mxv)), void();

    if (size == 3)
        return *__retval = uBox(::TYPES[97/*float3*/], ::g::Uno::Math::Clamp4(::g::Uno::Float3__New2(av.X, av.Y, av.Z), mnv, mxv)), void();

    if (size == 4)
        return *__retval = uBox(::TYPES[98/*float4*/], ::g::Uno::Math::Clamp6(av, mnv, mxv)), void();
...
{
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 0, ::STRINGS[14/*"/usr/local/...*/], 135);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[15/*"null"*/], 0, ::STRINGS[14/*"/usr/local/...*/], 121);
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[15/*"null"*/], 0, ::STRINGS[14/*"/usr/local/...*/], 99);
...
{
    ::STRINGS[42] = uString::Const("The binding type does not support resource subscriptions");
    ::TYPES[37] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
...
{
    U_THROW(::g::Uno::Exception::New2(::STRINGS[42/*"The binding...*/]));
}
...
{
    ::STRINGS[43] = uString::Const("Template contains a non-Node");
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.2.1/$.uno");
    ::STRINGS[44] = uString::Const("AddTemplate");
    ::STRINGS[45] = uString::Const("inconsistent instance state");
    ::STRINGS[46] = uString::Const("CompleteWindowItem");
    ::STRINGS[19] = uString::Const("");
    ...
    ::TYPES[47] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[48] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[40] = ::g::Fuse::Node_typeof();
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[49] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::TYPES[40/*Fuse.Node*/], NULL);
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
    ::TYPES[50] = Instantiator__CountItem_typeof();
    ::TYPES[4] = uObject_typeof()->Array();
    ::TYPES[30] = ::g::Fuse::IArray_typeof();
    ::TYPES[51] = ::g::Fuse::IObject_typeof();
    ::TYPES[52] = ::g::Fuse::ITemplateSource_typeof();
    ::TYPES[25] = ::g::Uno::String_typeof();
    ::TYPES[32] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[53] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[54] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[55] = ::g::Fuse::Reactive::Internal::PatchList_typeof()->MakeMethod(0/*Patch<object>*/, uObject_typeof(), NULL);
    ::TYPES[56] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[40/*Fuse.Node*/], NULL);
    ::TYPES[57] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(uObject_typeof(), Instantiator__WindowItem_typeof(), NULL);
    ::TYPES[58] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(uObject_typeof(), Instantiator__WindowItem_typeof(), NULL);
    ::TYPES[59] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), Instantiator__WindowItem_typeof(), NULL);
    ::TYPES[60] = ::g::Fuse::Internal::ObjectList_typeof()->MakeType(Instantiator__WindowItem_typeof(), NULL);
    ::TYPES[61] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ::TYPES[60/*Fuse.Internal.ObjectList<Fuse.Reactive.Instantiator.WindowItem>*/], offsetof(::g::Fuse::Reactive::Instantiator, _availableItems), 0,
        ::TYPES[59/*Uno.Collections.Dictionary<object, Fuse.Reactive.Instantiator.WindowItem>*/], offsetof(::g::Fuse::Reactive::Instantiator, _availableItemsById), 0,
        ::g::Fuse::Triggers::BusyTask_typeof(), offsetof(::g::Fuse::Reactive::Instantiator, _busyTask), 0,
        ::TYPES[56/*Uno.Action<Fuse.Node>*/], offsetof(::g::Fuse::Reactive::Instantiator, _completedRemove), 0,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[40/*Fuse.Node*/], Instantiator__WindowItem_typeof(), NULL), offsetof(::g::Fuse::Reactive::Instantiator, _dataMap), 0,
        ...
        ::TYPES[61/*Uno.Collections.RootableList<Uno.UX.Template>*/], offsetof(::g::Fuse::Reactive::Instantiator, _rootTemplates), 0,
        ::TYPES[48/*Uno.Collections.IList<Uno.UX.Template>*/], offsetof(::g::Fuse::Reactive::Instantiator, _templates), 0,
        ::TYPES[52/*Fuse.ITemplateSource*/], offsetof(::g::Fuse::Reactive::Instantiator, _templateSource), 0,
        ::TYPES[52/*Fuse.ITemplateSource*/], offsetof(::g::Fuse::Reactive::Instantiator, _weakTemplateSource), uFieldFlagsWeak,
        ::TYPES[60/*Fuse.Internal.ObjectList<Fuse.Reactive.Instantiator.WindowItem>*/], offsetof(::g::Fuse::Reactive::Instantiator, _windowItems), 0,
...
void Instantiator__FuseNodeISubtreeDataProviderGetData_fn(Instantiator* __this, ::g::Fuse::Node* n, uObject** __retval)
{
    ...
    {
        if (uIs((uObject*)uPtr(v)->Data, ::TYPES[50/*Fuse.Reactive.Instantiator.CountItem*/]))
            return *__retval = NULL, void();
...
void Instantiator__OnRooted_fn(Instantiator* __this)
{
    ...
    if (__this->_rootTemplates != NULL)
        uPtr(__this->_rootTemplates)->Subscribe(uDelegate::New(::TYPES[53/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, __this), uDelegate::New(::TYPES[53/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, __this));
...
bool Instantiator::AddMatchingTemplates(Instantiator__WindowItem* item, Instantiator__TemplateMatch f)
{
    ...
    else if (f.All)
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Templates()), ::TYPES[47/*Uno.Collections.ICollection<Uno.UX.Template>*/])); ++i)
            AddTemplate(item, (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Templates()), ::TYPES[48/*Uno.Collections.IList<Uno.UX.Template>*/]), uCRef<int>(i), &ret7), ret7));
    }
...
void Instantiator::AddTemplate(Instantiator__WindowItem* item, ::g::Uno::UX::Template* f)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[43/*"Template co...*/], this, ::STRINGS[34/*"/usr/local/...*/], 1978, ::STRINGS[44/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    if ((wi->Template.All && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Templates()), ::TYPES[47/*Uno.Collections.ICollection<Uno.UX.Template>*/])) != uPtr(wi->Nodes)->Count())) || ((wi->Template.Template != NULL) && (uPtr(wi->Nodes)->Count() != 1)))
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[45/*"inconsisten...*/], this, ::STRINGS[34/*"/usr/local/...*/], 1891, ::STRINGS[46/*"CompleteWin...*/]);

    ::g::Fuse::Node* lastNode = GetLastNodeFromIndex(windowIndex - 1);

    if (reuse)
        uPtr(Parent())->InsertOrMoveNodes((::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[49/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), lastNode, &ret9), ret9) + 1, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[40/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(wi)->Nodes), &ret10), ret10)));
    else
        uPtr(Parent())->InsertNodes((::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[49/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), lastNode, &ret11), ret11) + 1, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[40/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(wi)->Nodes), &ret12), ret12)));
}
...
{
    uObject* so = uAs<uObject*>(data, ::TYPES[51/*Fuse.IObject*/]);

    if ((so != NULL) && ::g::Uno::String::op_Inequality(key, NULL))
    {
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(so), ::TYPES[51/*Fuse.IObject*/]), key))
            return ::g::Fuse::IObject::Item(uInterface(uPtr(so), ::TYPES[51/*Fuse.IObject*/]), key);
    }
...
Instantiator__TemplateMatch Instantiator::GetDataTemplate(uObject* data)
{
    ...
    {
        ::g::Uno::UX::Template* t = ::g::Fuse::ITemplateSource::FindTemplate(uInterface(uPtr(_templateSource), ::TYPES[52/*Fuse.ITemplateSource*/]), TemplateKey());
    ...
    if (useTemplate == NULL)
    {
        ...
        for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Templates()), ::TYPES[47/*Uno.Collections.ICollection<Uno.UX.Template>*/])) - 1; i >= 0; --i)
        {
            ::g::Uno::UX::Template* f = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Templates()), ::TYPES[48/*Uno.Collections.IList<Uno.UX.Template>*/]), uCRef<int>(i), &ret17), ret17);
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Limit canno...*/], this, ::STRINGS[34/*"/usr/local/...*/], 1148, ::STRINGS[48/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Offset cann...*/], this, ::STRINGS[34/*"/usr/local/...*/], 1100, ::STRINGS[50/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void Instantiator::PatchTo(uObject* values)
{
    ...
    ::g::Uno::Collections::List* newIds = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[54/*Uno.Collections.List<object>*/]);
    ...
    ::g::Uno::Collections::List* curIds = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[54/*Uno.Collections.List<object>*/]);
    ...
    ::g::Uno::Collections::List* ops = (::g::Fuse::Reactive::Internal::PatchList__Patch_fn(::TYPES[55/*Fuse.Reactive.Internal.PatchList.Patch<object>*/], (uObject*)curIds, (uObject*)newIds, uCRef<int>(1), NULL, &ret19), ret19);
...
void Instantiator::RemoveFromParent(::g::Fuse::Node* n)
{
    if (::g::Uno::Delegate::op_Equality(_completedRemove, NULL))
        _completedRemove = uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Node>*/], (void*)Instantiator__CompletedRemove_fn, this);
...
void Instantiator::RemovePendingAvailableItems()
{
    ...
    {
        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uObject*>, uStrong<Instantiator__WindowItem*> > enum4 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(_availableItemsById), &ret22), ret22); enum4.MoveNext(::TYPES[57/*Uno.Collections.Dictionary<object, Fuse.Reactive.Instantiator.WindowItem>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uObject*>, uStrong<Instantiator__WindowItem*> > kvp = enum4.Current(::TYPES[57/*Uno.Collections.Dictionary<object, Fuse.Reactive.Instantiator.WindowItem>.Enumerator*/]);

            if (uPtr(kvp.Value(::TYPES[58/*Uno.Collections.KeyValuePair<object, Fuse.Reactive.Instantiator.WindowItem>*/]))->Nodes == NULL)
                continue;

            for (int n1 = 0; n1 < uPtr(uPtr(kvp.Value(::TYPES[58/*Uno.Collections.KeyValuePair<object, Fuse.Reactive.Instantiator.WindowItem>*/]))->Nodes)->Count(); ++n1)
                RemoveFromParent((::g::Uno::Collections::List__get_Item_fn(uPtr(uPtr(kvp.Value(::TYPES[58/*Uno.Collections.KeyValuePair<object, Fuse.Reactive.Instantiator.WindowItem>*/]))->Nodes), uCRef<int>(n1), &ret23), ret23));

            uPtr(kvp.Value(::TYPES[58/*Uno.Collections.KeyValuePair<object, Fuse.Reactive.Instantiator.WindowItem>*/]))->Unlink();
        }
...
void Instantiator::RemoveWindowItem(Instantiator__WindowItem* wi)
{
    ...
    {
        if (_availableItemsById == NULL)
            _availableItemsById = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[59/*Uno.Collections.Dictionary<object, Fuse.Reactive.Instantiator.WindowItem>*/]));
    ...
    {
        if (_availableItems == NULL)
            _availableItems = ((::g::Fuse::Internal::ObjectList*)::g::Fuse::Internal::ObjectList::New1(::TYPES[60/*Fuse.Internal.ObjectList<Fuse.Reactive.Instantiator.WindowItem>*/], 0));
...
uObject* Instantiator::Templates()
{
    ...
    _rootTemplates = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[61/*Uno.Collections.RootableList<Uno.UX.Template>*/]));

    if (IsRootingCompleted())
        uPtr(_rootTemplates)->Subscribe(uDelegate::New(::TYPES[53/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[53/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this));
...
{
    InstantiatorFunction::DataIndexName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[51/*"index"*/]);
    InstantiatorFunction::OffsetIndexName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[52/*"offsetIndex"*/]);
}

static void InstantiatorFunction_build(uType* type)
{
    ::STRINGS[51] = uString::Const("index");
    ::STRINGS[52] = uString::Const("offsetIndex");
    ::STRINGS[53] = uString::Const("too many parameters for ");
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.2.1/$.uno");
    ::STRINGS[54] = uString::Const("Subscribe");
    ::TYPES[62] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    ::TYPES[63] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::Expression_type, interface0));
    type->SetFields(1,
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    if (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])) > 1)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[53/*"too many pa...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->_item)), __this, ::STRINGS[34/*"/usr/local/...*/], 2311, ::STRINGS[54/*"Subscribe"*/], NULL);
        return *__retval = NULL, void();
    }

    ::g::Fuse::Reactive::Expression* node = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])) > 0) ? (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Arguments()), ::TYPES[63/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(0), &ret1), ret1) : NULL;
...
{
    ::STRINGS[55] = uString::Const("invalid search node for InstantiatorFunction");
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.2.1/$.uno");
    ::STRINGS[56] = uString::Const("OnNewNode");
    ::STRINGS[57] = uString::Const("Could not find an Instantiator");
    ::STRINGS[58] = uString::Const("Unable to resolve Instantiator node");
    ::TYPES[37] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
    ::TYPES[40] = ::g::Fuse::Node_typeof();
    ::TYPES[29] = ::g::Fuse::Reactive::IContext_typeof();
    ::TYPES[64] = ::TYPES[40/*Fuse.Node*/]->MakeMethod(0/*FindBehavior<Fuse.Reactive.Instantiator>*/, ::g::Fuse::Reactive::Instantiator_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[55/*"invalid sea...*/], this, ::STRINGS[34/*"/usr/local/...*/], 2369, ::STRINGS[56/*"OnNewNode"*/], NULL);
        return;
    }

    _instantiator = ((::g::Fuse::Reactive::Instantiator*)uPtr(searchNode)->FindBehavior(::TYPES[64/*Fuse.Node.FindBehavior<Fuse.Reactive.Instantiator>*/]));

    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[57/*"Could not f...*/], this, ::STRINGS[34/*"/usr/local/...*/], 2376, ::STRINGS[56/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[58/*"Unable to r...*/], this, ::STRINGS[34/*"/usr/local/...*/], 2387, ::STRINGS[56/*"OnNewNode"*/]);
        return;
    }
...
{
    ::STRINGS[59] = uString::Const("Cannot require() a rooted module");
    ::STRINGS[60] = uString::Const(" in ");
    ::STRINGS[61] = uString::Const(" line ");
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
    ::TYPES[31] = ::g::Uno::Type_typeof();
    ::TYPES[65] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[66] = ::g::Uno::UX::Resource_typeof()->MakeMethod(0/*GetGlobalsOfType<Fuse.Scripting.NativeModule>*/, ::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[67] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[32] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[68] = ::g::Uno::Collections::List_typeof()->MakeType(JavaScript__Dependency_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ...
        ::TYPES[68/*Uno.Collections.List<Fuse.Reactive.JavaScript.Dependency>*/], offsetof(::g::Fuse::Reactive::JavaScript, _dependencies), 0,
...
void JavaScript__FuseScriptingIModuleProviderGetModule_fn(JavaScript* __this, ::g::Fuse::Scripting::Module** __retval)
{
    if (__this->IsRootingCompleted())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[59/*"Cannot requ...*/]));
...
void JavaScript__OnUnrooted_fn(JavaScript* __this)
{
    ...
    if ((--JavaScript::_javaScriptCounter_) <= 0)
    {
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr((uObject*)::g::Uno::UX::Resource::GetGlobalsOfType(::TYPES[66/*Uno.UX.Resource.GetGlobalsOfType<Fuse.Scripting.NativeModule>*/])), ::TYPES[65/*Uno.Collections.IEnumerable<Fuse.Scripting.NativeModule>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[9/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Scripting::NativeModule* nm = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[67/*Uno.Collections.IEnumerator<Fuse.Scripting.NativeModule>*/]), &ret5), ret5);
...
uObject* JavaScript::Dependencies()
{
    if (_dependencies == NULL)
        _dependencies = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<Fuse.Reactive.JavaScript.Dependency>*/]));
...
{
    msg = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(msg, ::STRINGS[60/*" in "*/]), uPtr(ex)->FileName()), ::STRINGS[61/*" line "*/]), uBox<int>(::TYPES[21/*int*/], uPtr(ex)->LineNumber()));
...
void Lerp__Compute_fn(Lerp* __this, uObject* a, uObject* b, uObject* t, uObject** __retval)
{
    ...
    switch (size)
    {
        ...
        case 2:
            return *__retval = uBox(::TYPES[96/*float2*/], ::g::Uno::Math::Lerp2(::g::Uno::Float2__New2(av.X, av.Y), ::g::Uno::Float2__New2(bv.X, bv.Y), tv)), void();
        case 3:
            return *__retval = uBox(::TYPES[97/*float3*/], ::g::Uno::Math::Lerp4(::g::Uno::Float3__New2(av.X, av.Y, av.Z), ::g::Uno::Float3__New2(bv.X, bv.Y, bv.Z), tv)), void();
        case 4:
            return *__retval = uBox(::TYPES[98/*float4*/], ::g::Uno::Math::Lerp6(av, bv, tv)), void();
    }
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[62/*"lerp("*/], __this->First()), ::STRINGS[8/*","*/]), __this->Second()), ::STRINGS[8/*","*/]), __this->Third()), ::STRINGS[9/*")"*/]), void();
}
// }
...
{
    ::STRINGS[63] = uString::Const("Index must be a number: ");
    ::STRINGS[64] = uString::Const("Index was outside the bounds of the array");
    ::STRINGS[65] = uString::Const("Object does not contain the given key '");
    ::STRINGS[27] = uString::Const("'");
    ::STRINGS[66] = uString::Const("Look-up operator not supported on collection type: ");
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
    ::TYPES[32] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[6] = ::g::Fuse::Reactive::IListener_typeof();
    ::TYPES[30] = ::g::Fuse::IArray_typeof();
    ::TYPES[69] = ::g::Fuse::MarshalException_typeof();
    ::TYPES[51] = ::g::Fuse::IObject_typeof();
    type->SetInterfaces(
...
void LookUp__LookUpSubscription::ResultChanged()
{
    ...
    if (arr != NULL)
    {
        ...
        {
            if (uIs(__t.Exception, ::TYPES[69/*Fuse.MarshalException*/]))
            {
                ::g::Fuse::MarshalException* me = (::g::Fuse::MarshalException*)__t.Exception;
                SetDiagnostic(::g::Uno::String::op_Addition2(::STRINGS[63/*"Index must ...*/], uPtr(me)->Message()), (uObject*)uPtr(_lu)->Index());
                return;
            }
            else throw __t;
        }
        ...
        if ((index >= 0) && (index < ::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[30/*Fuse.IArray*/]))))
            ...
            SetDiagnostic(::STRINGS[64/*"Index was o...*/], (uObject*)uPtr(_lu)->Index());

        return;
    }

    uObject* obj = uAs<uObject*>(_collection, ::TYPES[51/*Fuse.IObject*/]);

    if (obj != NULL)
    {
        uString* key = ::g::Uno::Object::ToString(uPtr(_index));

        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(obj), ::TYPES[51/*Fuse.IObject*/]), key))
            PushNewData(::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[51/*Fuse.IObject*/]), key));
        else
            SetDiagnostic(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[65/*"Object does...*/], key), ::STRINGS[27/*"'"*/]), (uObject*)uPtr(_lu)->Index());

        return;
    }

    SetDiagnostic(::g::Uno::String::op_Addition1(::STRINGS[66/*"Look-up ope...*/], _collection), (uObject*)uPtr(_lu)->Collection());
}
...
{
    ::STRINGS[67] = uString::Const(" (ScriptMethod)");
    ::STRINGS[68] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[69] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
    ::TYPES[4] = uObject_typeof()->Array();
    ::TYPES[26] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[28] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[70] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[27] = ::g::Fuse::Scripting::Array_typeof();
    type->SetFields(0,
...
void ThreadWorker__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _m = m;
    _worker = worker;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[67/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[68/*"(function (...*/], uPtr(m)->Name), ::STRINGS[69/*" = function...*/])), ::TYPES[26/*Fuse.Scripting.Function*/]);
...
{
    uObject* self = uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[70/*Fuse.Scripting.External*/]))->Object;
...
{
    ::STRINGS[70] = uString::Const("exports");
    ::STRINGS[71] = uString::Const("JavaScript error in ");
    ::STRINGS[72] = uString::Const(" fixed!");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
    ::STRINGS[73] = uString::Const("EvaluateModule");
    ::STRINGS[74] = uString::Const("JavaScript error");
    ::TYPES[42] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[71] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::JavaScript__Dependency_typeof(), NULL);
    ::TYPES[72] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::JavaScript__Dependency_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Action_typeof();
    type->SetFields(1,
...
uObject* ModuleInstance::EvaluateExports()
{
    ...
    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[70/*"exports"*/]);
...
void ModuleInstance::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[71/*"JavaScript ...*/], uPtr(_js)->FileName()), ::STRINGS[72/*" fixed!"*/]), this, ::STRINGS[5/*"/usr/local/...*/], 669, ::STRINGS[73/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[74/*"JavaScript ...*/], se, this, ::STRINGS[5/*"/usr/local/...*/], 685, ::STRINGS[73/*"EvaluateMod...*/]);
...
{
    ::STRINGS[75] = uString::Const("Named object not found: ");
    ::TYPES[29] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
    type->SetFields(0,
...
void Name__GetValue_fn(Name* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[75/*"Named objec...*/], __this->Identifier())));
}
...
{
    ::TYPES[73] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this, uObject* sub)
{
    ...
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[73/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
...
{
    ::TYPES[42] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[74] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[5] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ::TYPES[11] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[75] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[74/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[74/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[75/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)((::g::Uno::Collections::Dictionary__KeyCollection*)uPtr(_props)->Keys()));
}
...
{
    ::STRINGS[76] = uString::Const("addSubscriber");
    ::STRINGS[77] = uString::Const("set");
    ::STRINGS[78] = uString::Const("clear");
    ::STRINGS[79] = uString::Const("newAt");
    ::STRINGS[80] = uString::Const("newAll");
    ::STRINGS[81] = uString::Const("add");
    ::STRINGS[82] = uString::Const("removeAt");
    ::STRINGS[83] = uString::Const("insertAt");
    ::STRINGS[84] = uString::Const("removeRange");
    ::STRINGS[85] = uString::Const("insertAll");
    ::STRINGS[86] = uString::Const("failed");
    ::STRINGS[87] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[88] = uString::Const("removeSubscriber");
    ::TYPES[54] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[76] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof(), NULL);
    ::TYPES[28] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[4] = uObject_typeof()->Array();
    ::TYPES[17] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[25] = ::g::Uno::String_typeof();
    ::TYPES[77] = ::g::Fuse::Reactive::ArrayMirror_typeof();
    ::TYPES[21] = ::g::Uno::Int_typeof();
    ::TYPES[23] = ::g::Uno::Double_typeof();
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[5] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ...
    type->SetFields(1,
        ...
        ::TYPES[76/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/], offsetof(::g::Fuse::Reactive::Observable, _observers), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::Observable, _usingObservers), 0,
        ::TYPES[54/*Uno.Collections.List<object>*/], offsetof(::g::Fuse::Reactive::Observable, _values), 0,
...
{
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[54/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[76/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/]));
    ctor_1(obj);
    _worker = worker;
    _observable = obj;
    ...
    uPtr(obj)->CallMethod(::STRINGS[76/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[24/*bool*/], supressCallback)));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[80/*"newAll"*/]))
        uPtr(_worker)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[77/*Fuse.Reactive.ArrayMirror*/]), origin));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[81/*"add"*/]))
        uPtr(_worker)->Enqueue(Observable__Add::New1(this, uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(3))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[82/*"removeAt"*/]))
        uPtr(_worker)->Enqueue(Observable__RemoveAt::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[83/*"insertAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[84/*"removeRange"*/]))
        uPtr(_worker)->Enqueue(Observable__RemoveRange::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), ToInt(uPtr(args)->Strong<uObject*>(4))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[85/*"insertAll"*/]))
        uPtr(_worker)->Enqueue(Observable__InsertAll::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(4)), ::TYPES[77/*Fuse.Reactive.ArrayMirror*/])));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[86/*"failed"*/]))
        uPtr(_worker)->Enqueue(Observable__Failed::New1(this, uAs<uString*>(uPtr(args)->Strong<uObject*>(3), ::TYPES[25/*string*/])));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[87/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[88/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
static void ObservableProperty_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[78] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_worker)->Invoke(uDelegate::New(::TYPES[15/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[78/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject1())));
}
...
{
    ::TYPES[79] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::Expression_type, interface0));
    type->SetFields(0,
...
{
    ::g::Uno::UX::PropertyObject* obj = uCast< ::g::Uno::UX::PropertyObject*>(uPtr(__this->Object())->GetValue(context), ::TYPES[79/*Uno.UX.PropertyObject*/]);
...
{
    ::STRINGS[89] = uString::Const("this._raw_");
    ::STRINGS[90] = uString::Const("this._");
    ::STRINGS[91] = uString::Const(" (ScriptProperty)");
    ::STRINGS[92] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[93] = uString::Const("', ");
    ::STRINGS[28] = uString::Const("{");
    ::STRINGS[94] = uString::Const("get: function() { ");
    ::STRINGS[95] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[96] = uString::Const("if (");
    ::STRINGS[97] = uString::Const(" != obs) {");
    ::STRINGS[98] = uString::Const(" = obs;");
    ::STRINGS[99] = uString::Const(" = obs");
    ::STRINGS[100] = uString::Const(";");
    ::STRINGS[29] = uString::Const("}");
    ::STRINGS[101] = uString::Const("return ");
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _worker = worker;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[89/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[90/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[91/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[92/*"(function(c...*/], p->Name), ::STRINGS[93/*"', "*/]), ::STRINGS[28/*"{"*/]), ::STRINGS[94/*"get: functi...*/]), ::STRINGS[95/*"var obs = g...*/]), ::STRINGS[96/*"if ("*/]), rawField), ::STRINGS[97/*" != obs) {"*/]), rawField), ::STRINGS[98/*" = obs;"*/]), propField), ::STRINGS[99/*" = obs"*/]), p->Modifier), ::STRINGS[100/*";"*/]), ::STRINGS[29/*"}"*/]), ::STRINGS[101/*"return "*/]), propField), ::STRINGS[29/*"}"*/]), ::STRINGS[102/*"})"*/]), ::STRINGS[102/*"})"*/])), ::TYPES[26/*Fuse.Scripting.Function*/]);
...
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Reactive::ThreadWorker::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[79/*Uno.UX.PropertyObject*/]);
...
{
    ::STRINGS[103] = uString::Const("{Resource ");
    ::STRINGS[40] = uString::Const("} not found in data context");
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
    ::TYPES[80] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(_origin)->TryGetResource(_key, uDelegate::New(::TYPES[80/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[6/*Fuse.Reactive.IListener*/]), _source, resource);
    else
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[103/*"{Resource "*/], _key), ::STRINGS[40/*"} not found...*/]), _origin);
}
...
static void RootableScriptModule_build(uType* type)
{
    ...
    ::TYPES[74] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[81] = ::g::Uno::Collections::IList_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->Dependencies), &ret4), ret4); enum1.MoveNext(::TYPES[74/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > dep = enum1.Current(::TYPES[74/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
        argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[104/*", "*/], dep.Key(::TYPES[11/*Uno.Collections.KeyValuePair<string, object>*/])));
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[104/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(i)));
            ::g::Uno::Collections::List__Add_fn(uPtr(args), uPtr(__this->_worker)->Unwrap((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nt->Objects()), ::TYPES[81/*Uno.Collections.IList<object>*/]), uCRef<int>(i), &ret5), ret5)));
        }
...
{
    ::STRINGS[78] = uString::Const("clear");
    ::STRINGS[105] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[106] = uString::Const("Unexpected null object");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
    ::STRINGS[107] = uString::Const("SetExclusive");
    ::STRINGS[108] = uString::Const("setValueWithOrigin");
    ::STRINGS[109] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[4] = uObject_typeof()->Array();
    ::TYPES[30] = ::g::Fuse::IArray_typeof();
    ::TYPES[12] = ::g::Fuse::Scripting::ScriptException_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[78/*"clear"*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 1, uBox<int>(::TYPES[21/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uObject* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[105/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, sa, uBox<int>(::TYPES[21/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[106/*"Unexpected ...*/], this, ::STRINGS[5/*"/usr/local/...*/], 830, ::STRINGS[107/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[108/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_worker)->Unwrap(newValue), uBox<int>(::TYPES[21/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[12/*Fuse.Scripting.ScriptException*/]))
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[109/*"Failed to s...*/], ex, this, ::STRINGS[5/*"/usr/local/...*/], 845, ::STRINGS[107/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    ::TYPES[82] = ::g::Fuse::Reactive::VarArgFunction__Argument_typeof()->Array();
    ::TYPES[62] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    ::TYPES[63] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    type->SetInterfaces(
        ...
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(::g::Fuse::Reactive::InnerListener_type, interface1));
    type->SetFields(2,
        ::TYPES[82/*Fuse.Reactive.VarArgFunction.Argument[]*/], offsetof(::g::Fuse::Reactive::SimpleVarArgFunction__Subscription, _arguments), 0,
...
void SimpleVarArgFunction__Subscription__OnNewData_fn(SimpleVarArgFunction__Subscription* __this, uObject* source, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(__this->_func)->Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
        if ((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(__this->_func)->Arguments()), ::TYPES[63/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret3), ret3) == source)
        {
...
void SimpleVarArgFunction__Subscription::ctor_1(::g::Fuse::Reactive::SimpleVarArgFunction* func, uObject* context, uObject* listener)
{
    ...
    _func = func;
    _listener = listener;
    _arguments = uArray::New(::TYPES[82/*Fuse.Reactive.VarArgFunction.Argument[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(func)->Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])));

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(func->Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
        uPtr(_arguments)->Strong< ::g::Fuse::Reactive::VarArgFunction__Argument*>(i) = ::g::Fuse::Reactive::VarArgFunction__Argument::New1();

    for (int i1 = 0; i1 < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(func->Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i1++)
        uPtr(uPtr(_arguments)->Strong< ::g::Fuse::Reactive::VarArgFunction__Argument*>(i1))->Subscription = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(func)->Arguments()), ::TYPES[63/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i1), &ret2), ret2))->Subscribe(context, (uObject*)this);
...
{
    ::STRINGS[110] = uString::Const("Name table missing 'this' pointer");
    ::STRINGS[111] = uString::Const("this");
    ::TYPES[29] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
}
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(uObject_typeof(), uArray::New(::TYPES[83/*Fuse.Scripting.ScriptMember[]*/], 0));
}

static void ThreadWorker_build(uType* type)
{
    ::STRINGS[112] = uString::Const("Skipped Exception");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
    ::STRINGS[113] = uString::Const("CheckAndThrow");
    ::STRINGS[114] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[115] = uString::Const("CreateMirror");
    ::STRINGS[116] = uString::Const("Cannot use object of type '");
    ::STRINGS[117] = uString::Const("' as 'this' in JavaScript module; must be 'IProperties' or 'App'");
    ::STRINGS[118] = uString::Const("external_object");
    ::STRINGS[119] = uString::Const(" (ScriptClass)");
    ::STRINGS[120] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[121] = uString::Const("(set-superclass)");
    ::STRINGS[122] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[33] = uString::Const(".");
    ::STRINGS[67] = uString::Const(" (ScriptMethod)");
    ::STRINGS[123] = uString::Const("(function(cl, Observable) { cl.prototype.");
    ::STRINGS[124] = uString::Const(" = ");
    ::STRINGS[125] = uString::Const("; })");
    ::STRINGS[126] = uString::Const("ThreadWorked failed");
    ::STRINGS[127] = uString::Const("Run");
    ::STRINGS[128] = uString::Const("Could not create script context");
    ::TYPES[31] = ::g::Uno::Type_typeof();
    ::TYPES[83] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[84] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Observable__Operation_typeof(), NULL);
    ::TYPES[85] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Scripting::ScriptClass_typeof(), ::g::Fuse::Scripting::Function_typeof(), NULL);
    ::TYPES[86] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[87] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[88] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[27] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[17] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[89] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[90] = ::g::Fuse::IProperties_typeof();
    ::TYPES[91] = ::g::Fuse::Reactive::ClassInstance_typeof();
    ::TYPES[70] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[4] = uObject_typeof()->Array();
    ::TYPES[92] = ::g::Fuse::Scripting::ScriptMethodInline_typeof();
    ::TYPES[93] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[94] = ::g::Fuse::Scripting::ScriptProperty_typeof();
    ::TYPES[34] = ::g::Uno::Exception_typeof();
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[25] = ::g::Uno::String_typeof();
    ::TYPES[95] = ::g::Fuse::IRaw_typeof();
    ::TYPES[96] = ::g::Uno::Float2_typeof();
    ::TYPES[97] = ::g::Uno::Float3_typeof();
    ::TYPES[98] = ::g::Uno::Float4_typeof();
    ::TYPES[99] = ::g::Uno::Int2_typeof();
    ::TYPES[100] = ::g::Uno::Int3_typeof();
    ::TYPES[101] = ::g::Uno::Int4_typeof();
    ::TYPES[22] = ::g::Uno::Float_typeof();
    ::TYPES[21] = ::g::Uno::Int_typeof();
    ::TYPES[102] = ::g::Uno::UInt_typeof();
    ::TYPES[103] = ::g::Fuse::Scripting::IScriptObject_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[87/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _exceptionQueue), 0,
        ::g::Uno::Threading::ManualResetEvent_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _idle), 0,
        ::TYPES[84/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _messages), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _messagesMutex), 0,
        ::TYPES[86/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _queue), 0,
        ...
        ::TYPES[85/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _registeredClasses), 0,
...
{
    _messages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[84/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/]));
    _messagesMutex = ::g::Uno::Object::New();
    _registeredClasses = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[85/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/]));
    ...
    _queue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[86/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    _exceptionQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[87/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
    _thread = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[88/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
    uPtr(_ready)->Dispose();
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[112/*"Skipped Exc...*/], next, this, ::STRINGS[5/*"/usr/local/...*/], 2053, ::STRINGS[113/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[114/*"JavaScript ...*/], this, ::STRINGS[5/*"/usr/local/...*/], 1623, ::STRINGS[115/*"CreateMirror"*/]);
        return NULL;
    }
...
{
    ::g::Fuse::Platform::Lifecycle::remove_Terminating(uDelegate::New(::TYPES[89/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
    uPtr(_terminate)->Set();
    uPtr(_thread)->Join();
...
{
    uObject* n = uAs<uObject*>(obj, ::TYPES[90/*Fuse.IProperties*/]);

    if (n != NULL)
    {
        ::g::Fuse::Reactive::ClassInstance* ni = uAs< ::g::Fuse::Reactive::ClassInstance*>(uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[90/*Fuse.IProperties*/])))->Get(_classInstanceProperty), ::TYPES[91/*Fuse.Reactive.ClassInstance*/]);

        if (ni == NULL)
        {
            ni = ::g::Fuse::Reactive::ClassInstance::New1(this, obj, rootTable);
            uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[90/*Fuse.IProperties*/])))->Set(_classInstanceProperty, ni);
        }

        return ni;
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[116/*"Cannot use ...*/], ::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(uPtr(uPtr(rootTable)->This()))))), ::STRINGS[117/*"' as 'this'...*/])));
}
...
{
    ::g::Fuse::Scripting::External* e = uAs< ::g::Fuse::Scripting::External*>(obj, ::TYPES[70/*Fuse.Scripting.External*/]);
    ...
    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[118/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[118/*"external_ob...*/]), ::TYPES[70/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[119/*" (ScriptCla...*/]), ::STRINGS[120/*"(function(e...*/]), ::TYPES[26/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::STRINGS[121/*"(set-superc...*/], ::STRINGS[122/*"(function(c...*/]), ::TYPES[26/*Fuse.Scripting.Function*/]);
    ...
    {
        ::g::Fuse::Scripting::ScriptMethodInline* inlineMethod = uAs< ::g::Fuse::Scripting::ScriptMethodInline*>(uPtr(uPtr(sc)->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[92/*Fuse.Scripting.ScriptMethodInline*/]);

        if (inlineMethod != NULL)
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[33/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[67/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[123/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[124/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[125/*"; })"*/])), ::TYPES[26/*Fuse.Scripting.Function*/]);
            uPtr(m)->Call(uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, cl, (::g::Fuse::Scripting::Function*)uPtr(Context())->Observable()));
            continue;
        }

        ::g::Fuse::Scripting::ScriptMethod* method = uAs< ::g::Fuse::Scripting::ScriptMethod*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[93/*Fuse.Scripting.ScriptMethod*/]);
        ...
        ::g::Fuse::Scripting::ScriptProperty* property = uAs< ::g::Fuse::Scripting::ScriptProperty*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[94/*Fuse.Scripting.ScriptProperty*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[126/*"ThreadWorke...*/], e, this, ::STRINGS[5/*"/usr/local/...*/], 1949, ::STRINGS[127/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
        ...
        if (ThreadWorker::_context() == NULL)
        {
            ...
            if (ThreadWorker::_context() == NULL)
                U_THROW(::g::Uno::Exception::New2(::STRINGS[128/*"Could not c...*/]));
    ...
    while (true)
    {
        ...
        if (!_subscribedForClosing)
        {
            ...
            {
                ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[89/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
...
uObject* ThreadWorker::Unwrap(uObject* dc)
{
    if (dc == NULL)
        ...
        return dc;
    else if (uIs(dc, ::TYPES[95/*Fuse.IRaw*/]))
        return ::g::Fuse::IRaw::Raw(uInterface(uPtr((uObject*)dc), ::TYPES[95/*Fuse.IRaw*/]));
    else if (uIs(dc, ::TYPES[26/*Fuse.Scripting.Function*/]))
        return dc;
    else if (uIs(dc, ::TYPES[96/*float2*/]))
        return ToArray(uUnbox< ::g::Uno::Float2>(::TYPES[96/*float2*/], dc));
    else if (uIs(dc, ::TYPES[97/*float3*/]))
        return ToArray1(uUnbox< ::g::Uno::Float3>(::TYPES[97/*float3*/], dc));
    else if (uIs(dc, ::TYPES[98/*float4*/]))
        return ToArray2(uUnbox< ::g::Uno::Float4>(::TYPES[98/*float4*/], dc));
    else if (uIs(dc, ::TYPES[99/*int2*/]))
        return ToArray3(uUnbox< ::g::Uno::Int2>(::TYPES[99/*int2*/], dc));
    else if (uIs(dc, ::TYPES[100/*int3*/]))
        return ToArray4(uUnbox< ::g::Uno::Int3>(::TYPES[100/*int3*/], dc));
    else if (uIs(dc, ::TYPES[101/*int4*/]))
        return ToArray5(uUnbox< ::g::Uno::Int4>(::TYPES[101/*int4*/], dc));
...
{
    uObject* so = uAs<uObject*>(obj, ::TYPES[103/*Fuse.Scripting.IScriptObject*/]);

    if ((so != NULL) && (::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[103/*Fuse.Scripting.IScriptObject*/])) != NULL))
        return ::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[103/*Fuse.Scripting.IScriptObject*/]));
    ...
    if (so != NULL)
        ::g::Fuse::Scripting::IScriptObject::SetScriptObject(uInterface(uPtr(so), ::TYPES[103/*Fuse.Scripting.IScriptObject*/]), res, Context());
...
uObject* ThreadWorker::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[70/*Fuse.Scripting.External*/]))
        return uPtr(uCast< ::g::Fuse::Scripting::External*>(obj, ::TYPES[70/*Fuse.Scripting.External*/]))->Object;
    ...
    if (uIs(obj, ::TYPES[102/*uint*/]))
        return uBox(::TYPES[23/*double*/], (double)uUnbox<uint32_t>(::TYPES[102/*uint*/], obj));
...
{
    ::TYPES[104] = ValueForwarder__IValueListener_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface0),
        ::g::Fuse::Reactive::IObserver_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface1));
    type->SetFields(2,
        ::TYPES[104/*Fuse.Reactive.ValueForwarder.IValueListener*/], offsetof(::g::Fuse::Reactive::ValueForwarder, _listener), 0);
}
...
{
    ValueForwarder__IValueListener::NewValue(uInterface(uPtr(__this->_listener), ::TYPES[104/*Fuse.Reactive.ValueForwarder.IValueListener*/]), newValue);
}
...
uString* VarArgFunction::FormatString(uString* funcName)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Arguments()), ::TYPES[62/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); ++i)
    {
        if (i > 0)
            q = ::g::Uno::String::op_Addition2(q, ::STRINGS[8/*","*/]);

        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::Object::ToString(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Arguments()), ::TYPES[63/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret1), ret1))));
    }
