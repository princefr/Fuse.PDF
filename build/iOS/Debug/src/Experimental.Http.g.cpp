...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Experimental.Http/1.2.1/$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 0, ::STRINGS[9/*"/usr/local/...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 0, ::STRINGS[9/*"/usr/local/...*/], 854);
