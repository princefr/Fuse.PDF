// This file was generated based on /usr/local/share/uno/Packages/Fuse.WebSockets/1.2.1/ios/jetfire/$.uno.
...
static void WebSocketClient_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Action_typeof(), offsetof(::g::Jetfire::WebSocketClient, _close), 0,
        ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::Jetfire::WebSocketClient, _error), 0,
        ::g::Uno::Action_typeof(), offsetof(::g::Jetfire::WebSocketClient, _open), 0,
        ::g::ObjC::Object_typeof(), offsetof(::g::Jetfire::WebSocketClient, _webSocket), 0);
}
...
WebSocketClient_type* WebSocketClient_typeof()
{
    ...
    type = (WebSocketClient_type*)uClassType::New("Jetfire.WebSocketClient", options);
...
// public void Connect() :57
void WebSocketClient__Connect_fn(WebSocketClient* __this)
{
    __this->Connect();
}

// public void Create(string uri, string[] protocols, Uno.Action open, Uno.Action close, Uno.Action<string> error, Uno.Action<string> receiveMessage, Uno.Action<byte[]> receiveData) :22
...
// private ObjC.Object Create(string url, string[] protocols, Uno.Action<string, string> eventHandler, Uno.Action<string> receiveMessageHandler, Uno.Action<byte[]> receiveDataHandler) :38
...
// private void HandleEvent(string type, string message) :87
...
// public void Connect() [instance] :57
...
// public void Create(string uri, string[] protocols, Uno.Action open, Uno.Action close, Uno.Action<string> error, Uno.Action<string> receiveMessage, Uno.Action<byte[]> receiveData) [instance] :22
...
// private ObjC.Object Create(string url, string[] protocols, Uno.Action<string, string> eventHandler, Uno.Action<string> receiveMessageHandler, Uno.Action<byte[]> receiveDataHandler) [instance] :38
...
// private void HandleEvent(string type, string message) [instance] :87
...
// public void Send(byte[] data) [instance] :75
...
// public void Send(string data) [instance] :69
