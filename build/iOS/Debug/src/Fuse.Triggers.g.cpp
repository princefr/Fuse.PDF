...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[3/*"/usr/local/...*/], 203, ::STRINGS[7/*"UpdateState"*/], NULL);
        }
        else
...
void Busy::activate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"/usr/local/...*/], 264, ::STRINGS[0/*"activate"*/], NULL);
        return;
    }
...
void Busy::deactivate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"/usr/local/...*/], 282, ::STRINGS[1/*"deactivate"*/], NULL);
        return;
    }
...
void Completed::reset(::g::Fuse::Scripting::Context* c, Completed* cp, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Completed.r...*/], cp, ::STRINGS[3/*"/usr/local/...*/], 824, ::STRINGS[10/*"reset"*/], NULL);
        return;
    }
...
uObject* BusyTaskModule__ConstructorClosure::Construct(uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[12/*"Use the `Bu...*/], this, ::STRINGS[3/*"/usr/local/...*/], 580, ::STRINGS[13/*"Construct"*/]);
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.2.1/triggers/$.uno
// ---------------------------------------------------------------------------

// private sealed class IScrolledLengths.ContentSizeLength :678
// {
...
// public generated ContentSizeLength() :678
void IScrolledLengths__ContentSizeLength__ctor__fn(IScrolledLengths__ContentSizeLength* __this)
{
    __this->ctor_();
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) :680
...
// public generated ContentSizeLength New() :678
...
// public generated ContentSizeLength() [instance] :678
void IScrolledLengths__ContentSizeLength::ctor_()
{
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) [instance] :680
...
// public generated ContentSizeLength New() [static] :678
...
// public abstract interface IScrolledLength :647
// {
...
// internal static bool GetSizeChange(Fuse.Node n, float2& oldSize, float2& newSize) :142
...
// internal static void SetSizeChange(Fuse.Node n, float2 oldSize, float2 newSize) :137
...
// internal static bool GetSizeChange(Fuse.Node n, float2& oldSize, float2& newSize) [static] :142
...
// internal static void SetSizeChange(Fuse.Node n, float2 oldSize, float2 newSize) [static] :137
...
{
    ::STRINGS[16] = uString::Const("WebView");
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/1.2.1/$.uno");
    ::STRINGS[18] = uString::Const("OnRooted");
    ::TYPES[24] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[5] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(32,
        ::TYPES[24/*Fuse.Controls.IWebView*/], offsetof(::g::Fuse::Triggers::PageLoaded, _webView), 0);
}
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[24/*Fuse.Controls.IWebView*/]))
    {
        __this->_webView = uAs<uObject*>(__this->Parent(), ::TYPES[24/*Fuse.Controls.IWebView*/]);
        ::g::Fuse::Controls::IWebView::add_PageLoaded(uInterface(uPtr(__this->_webView), ::TYPES[24/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[5/*Uno.EventHandler*/], (void*)PageLoaded__OnPageLoaded_fn, __this));
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[16/*"WebView"*/], __this->Parent(), __this, ::STRINGS[17/*"/usr/local/...*/], 1142, ::STRINGS[18/*"OnRooted"*/]);
}
...
void PageLoaded__OnUnrooted_fn(PageLoaded* __this)
{
    ...
    {
        ::g::Fuse::Controls::IWebView::remove_PageLoaded(uInterface(uPtr(__this->_webView), ::TYPES[24/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[5/*Uno.EventHandler*/], (void*)PageLoaded__OnPageLoaded_fn, __this));
...
// private sealed class IScrolledLengths.PixelsLength :666
// {
...
// public generated PixelsLength() :666
void IScrolledLengths__PixelsLength__ctor__fn(IScrolledLengths__PixelsLength* __this)
{
    __this->ctor_();
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) :668
...
// public generated PixelsLength New() :666
...
// public generated PixelsLength() [instance] :666
void IScrolledLengths__PixelsLength::ctor_()
{
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) [instance] :668
...
// public generated PixelsLength New() [static] :666
...
// private sealed class IScrolledLengths.PointsLength :654
// {
...
// public generated PointsLength() :654
void IScrolledLengths__PointsLength__ctor__fn(IScrolledLengths__PointsLength* __this)
{
    __this->ctor_();
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) :656
...
// public generated PointsLength New() :654
...
// public generated PointsLength() [instance] :654
void IScrolledLengths__PointsLength::ctor_()
{
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) [instance] :656
...
// public generated PointsLength New() [static] :654
...
{
    ::TYPES[25] = PulseTrigger__PulseHandler_typeof();
    type->SetPrecalc(
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(32,
        ::TYPES[25/*Fuse.Triggers.PulseTrigger`1.PulseHandler*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::PulseTrigger, Handler1), 0);
}
...
{
    ::STRINGS[19] = uString::Const("Double removal of Visual");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[19/*"Double remo...*/], __this, ::STRINGS[3/*"/usr/local/...*/], 1742, ::STRINGS[20/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"Unexpected ...*/], this, ::STRINGS[3/*"/usr/local/...*/], 1755, ::STRINGS[22/*"OnDone"*/]);
        return;
    }
...
// public object Subscribe(Fuse.ITransformRelative transform) :124
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :125
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :124
uObject* LayoutTransition__ScaleChangeMode::Subscribe(uObject* transform)
{
    return NULL;
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :125
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Scrolled>*/], ::STRINGS[23/*"check"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Scrolled, object[]>*/], (void*)Scrolled__check_fn), 2)));
}

static void Scrolled_build(uType* type)
{
    ::STRINGS[23] = uString::Const("check");
    ::STRINGS[24] = uString::Const("check takes no parameters");
    ::STRINGS[25] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.2.1/triggers/$.uno");
    ::STRINGS[26] = uString::Const("Scrolled could not find a Scrollable control.");
    ::STRINGS[18] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[28] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FindByType<Fuse.Controls.ScrollViewBase>*/, ::g::Fuse::Controls::ScrollViewBase_typeof(), NULL);
    ::TYPES[29] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollViewBase*)uPtr(__this->Parent())->FindByType(::TYPES[28/*Fuse.Visual.FindByType<Fuse.Controls.ScrollViewBase>*/]));

    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"Scrolled co...*/], __this, ::STRINGS[25/*"/usr/local/...*/], 288, ::STRINGS[18/*"OnRooted"*/], NULL);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[29/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scrolled__OnScrollPositionChanged_fn, __this));
...
void Scrolled__OnUnrooted_fn(Scrolled* __this)
{
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[29/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scrolled__OnScrollPositionChanged_fn, __this));
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[24/*"check takes...*/], s, ::STRINGS[25/*"/usr/local/...*/], 242, ::STRINGS[23/*"check"*/], NULL);
        return;
    }
...
// internal sealed class ScrollRegion :715
// {
static void ScrollRegion_build(uType* type)
{
    ::TYPES[30] = ::g::Fuse::Triggers::IScrolledLength_typeof();
    type->SetFields(0,
        ::TYPES[30/*Fuse.Triggers.IScrolledLength*/], offsetof(::g::Fuse::Triggers::ScrollRegion, RelativeTo), 0,
...
// private float2 CalcWithin(Fuse.Controls.ScrollViewBase scrollable) :744
...
// public bool IsInZone(Fuse.Controls.ScrollViewBase scrollable) :749
...
// private float2 CalcWithin(Fuse.Controls.ScrollViewBase scrollable) [instance] :744
::g::Uno::Float2 ScrollRegion::CalcWithin(::g::Fuse::Controls::ScrollViewBase* scrollable)
{
    return ::g::Fuse::Triggers::IScrolledLength::GetPoints(uInterface(uPtr(RelativeTo), ::TYPES[30/*Fuse.Triggers.IScrolledLength*/]), Within, scrollable);
}

// public bool IsInZone(Fuse.Controls.ScrollViewBase scrollable) [instance] :749
...
// private sealed class IScrolledLengths.ScrollViewSizeLength :691
// {
...
// public generated ScrollViewSizeLength() :691
void IScrolledLengths__ScrollViewSizeLength__ctor__fn(IScrolledLengths__ScrollViewSizeLength* __this)
{
    __this->ctor_();
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) :693
...
// public generated ScrollViewSizeLength New() :691
...
// public generated ScrollViewSizeLength() [instance] :691
void IScrolledLengths__ScrollViewSizeLength::ctor_()
{
}

// public float2 GetPoints(float value, Fuse.Controls.ScrollViewBase scrollable) [instance] :693
...
// public generated ScrollViewSizeLength New() [static] :691
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[31/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[27/*"goto"*/], uDelegate::New(::TYPES[32/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}

static void State_build(uType* type)
{
    ::STRINGS[27] = uString::Const("goto");
    ::STRINGS[28] = uString::Const("Cannot call `Goto` on an unrooted `State`");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Cannot call...*/], NULL, ::STRINGS[3/*"/usr/local/...*/], 2110, ::STRINGS[29/*"Goto"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[33/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[27/*"goto"*/], uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__goto__fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[33/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[30/*"gotoNext"*/], uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__gotoNext_fn), 2)));
}

static void StateGroup_build(uType* type)
{
    ::STRINGS[27] = uString::Const("goto");
    ::STRINGS[30] = uString::Const("gotoNext");
    ::STRINGS[31] = uString::Const("StateGroup.goto requires 1 argument");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
    ::STRINGS[32] = uString::Const("goto_");
    ::STRINGS[33] = uString::Const("Unable to find State with Name: ");
    ::STRINGS[34] = uString::Const("gotoName");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[33] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[34] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[21] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[22] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[23] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[35] = ::g::Uno::String_typeof();
    ::TYPES[36] = ::g::Fuse::Triggers::State_typeof();
    ::TYPES[37] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[38] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[36/*Fuse.Triggers.State*/], NULL);
    ::TYPES[39] = ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[36/*Fuse.Triggers.State*/], NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Node_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Node_type, interface2),
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface5));
    type->SetFields(12,
        ::TYPES[36/*Fuse.Triggers.State*/], offsetof(::g::Fuse::Triggers::StateGroup, _active), 0,
        ::TYPES[39/*Uno.Collections.IList<Fuse.Triggers.State>*/], offsetof(::g::Fuse::Triggers::StateGroup, _states), 0,
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"StateGroup....*/], n, ::STRINGS[3/*"/usr/local/...*/], 1825, ::STRINGS[32/*"goto_"*/], NULL);
        return;
    }

    if (uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[35/*string*/]))
        StateGroup::gotoName(c, n, uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[35/*string*/]));
    else
        uPtr(n)->Goto(uAs< ::g::Fuse::Triggers::State*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[36/*Fuse.Triggers.State*/]));
}
...
{
    StateGroup_typeof()->Init();
    ::g::Fuse::Triggers::State* state = uAs< ::g::Fuse::Triggers::State*>(uPtr(n)->FindObjectByName(::g::Uno::UX::Selector__op_Implicit(name), uDelegate::New(::TYPES[37/*Uno.Predicate<object>*/], (void*)StateGroup__StateAcceptor_fn)), ::TYPES[36/*Fuse.Triggers.State*/]);

    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[33/*"Unable to f...*/], name), n, ::STRINGS[3/*"/usr/local/...*/], 1805, ::STRINGS[34/*"gotoName"*/], NULL);
        return;
    }
...
{
    StateGroup_typeof()->Init();
    return uIs(o, ::TYPES[36/*Fuse.Triggers.State*/]);
}
// }
...
{
    Timeline::_progressName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[35/*"Progress"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 9, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[36/*"pause"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pause_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[37/*"pulse"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulse_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[38/*"pulseBackward"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulseBackward_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[39/*"pulseForward"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulseForward_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[40/*"play"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__resume_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[41/*"playTo"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__playTo_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[42/*"resume"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__resume_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[43/*"seek"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__seek_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[40/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[44/*"stop"*/], uDelegate::New(::TYPES[41/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__stop_fn), 2)));
}

static void Timeline_build(uType* type)
{
    ::STRINGS[35] = uString::Const("Progress");
    ::STRINGS[36] = uString::Const("pause");
    ::STRINGS[37] = uString::Const("pulse");
    ::STRINGS[38] = uString::Const("pulseBackward");
    ::STRINGS[39] = uString::Const("pulseForward");
    ::STRINGS[40] = uString::Const("play");
    ::STRINGS[41] = uString::Const("playTo");
    ::STRINGS[42] = uString::Const("resume");
    ::STRINGS[43] = uString::Const("seek");
    ::STRINGS[44] = uString::Const("stop");
    ::STRINGS[45] = uString::Const("Timeline.seek requires 1 argument");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[40] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[41] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[42] = ::g::Uno::UX::IPropertyListener_typeof();
    ::TYPES[43] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[44] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(32,
        ...
        ::TYPES[42/*Uno.UX.IPropertyListener*/], offsetof(::g::Fuse::Triggers::Timeline, _progressOrigin), 0,
        ...
        ::TYPES[44/*Uno.UX.ValueChangedHandler<double>*/], offsetof(::g::Fuse::Triggers::Timeline, ProgressChanged1), 0,
...
void Timeline__OnProgressChanged_fn(Timeline* __this)
{
    ...
    uObject* sender = (ind1 != NULL) ? ind1 : uAs<uObject*>(__this, ::TYPES[42/*Uno.UX.IPropertyListener*/]);
    __this->OnPropertyChanged1(Timeline::_progressName(), sender);

    if (::g::Uno::Delegate::op_Inequality(__this->ProgressChanged1, NULL))
        uPtr(__this->ProgressChanged1)->Invoke(2, sender, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[43/*Uno.UX.ValueChangedArgs<double>*/], uCRef(__this->Progress1()), &ret3), ret3));
}
...
{
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ProgressChanged1, value), ::TYPES[44/*Uno.UX.ValueChangedHandler<double>*/]);
}
...
{
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ProgressChanged1, value), ::TYPES[44/*Uno.UX.ValueChangedHandler<double>*/]);
}
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Timeline.se...*/], n, ::STRINGS[3/*"/usr/local/...*/], 2536, ::STRINGS[41/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Timeline.se...*/], n, ::STRINGS[3/*"/usr/local/...*/], 2585, ::STRINGS[43/*"seek"*/], NULL);
        return;
    }
...
static void Transition_build(uType* type)
{
    ...
    ::TYPES[46] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[47] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    ::TYPES[48] = ::g::Fuse::Internal::MiniList_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->SetFields(32,
        ...
        ::TYPES[48/*Fuse.Internal.MiniList<string>*/], offsetof(::g::Fuse::Triggers::Transition, _from), 0,
        ...
        ::TYPES[48/*Fuse.Internal.MiniList<string>*/], offsetof(::g::Fuse::Triggers::Transition, _to), 0,
...
void Transition__OnRooted_fn(Transition* __this)
{
    ...
    if (__this->_group != NULL)
    {
        ...
        uPtr(uPtr(__this->_group)->Navigator())->add_PageProgressChanged(uDelegate::New(::TYPES[47/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
    }
}
...
void Transition__OnUnrooted_fn(Transition* __this)
{
    ...
    if (__this->_useAnimator != NULL)
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(__this->Animators()), ::TYPES[45/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), __this->_useAnimator, &ret2);

    if (__this->_group != NULL)
    {
        uPtr(uPtr(__this->_group)->Navigator())->remove_PageProgressChanged(uDelegate::New(::TYPES[47/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
        uPtr(uPtr(__this->_group)->Navigator())->SetTransitionState(__this, false);
...
void Transition::AddUseTransition()
{
    ...
    if (_useAnimator != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[45/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), _useAnimator);
}
...
void Transition::OnPageProgressChanged(uObject* sender, ::g::Fuse::Navigation::NavigationArgs* args)
{
    ...
    ::g::Fuse::Navigation::NavigationPageState ps = ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(uAs<uObject*>(uPtr(_group)->Navigator(), ::TYPES[46/*Fuse.Navigation.INavigation*/])), ::TYPES[46/*Fuse.Navigation.INavigation*/]), uPtr(_group)->Page());
...
int Transition::Priority(bool isActive, bool isBackward, uString* newPath, uString* oldPath, int mode, uString* operationStyle)
{
    ...
    if (_to.Count(::TYPES[48/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (!normActive && _to.Contains(::TYPES[48/*Fuse.Internal.MiniList<string>*/], toPath))
            return priority + 20;

        return -1;
    }

    if (_from.Count(::TYPES[48/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (normActive && _from.Contains(::TYPES[48/*Fuse.Internal.MiniList<string>*/], fromPath))
            return priority + 10;
...
{
    TransitionGroup::_groupMap_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[49/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/]));
}

static void TransitionGroup_build(uType* type)
{
    ::STRINGS[46] = uString::Const("Transition must have a Navigator ancestor");
    ::STRINGS[47] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.2.1/$.uno");
    ::STRINGS[48] = uString::Const("Root");
    ::STRINGS[49] = uString::Const("Transition must have a Visual parent");
    ::TYPES[49] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), type, NULL);
    ::TYPES[50] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Transition_typeof(), NULL);
    ::TYPES[51] = ::g::Fuse::Controls::NavigationSwitchedHandler_typeof();
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[52] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    type->SetFields(0,
        ::TYPES[52/*Fuse.Controls.Navigator*/], offsetof(::g::Fuse::Triggers::TransitionGroup, _navigator), 0,
        ...
        ::TYPES[50/*Uno.Collections.List<Fuse.Triggers.Transition>*/], offsetof(::g::Fuse::Triggers::TransitionGroup, _states), 0,
        ::TYPES[49/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/], (uintptr_t)&::g::Fuse::Triggers::TransitionGroup::_groupMap_, uFieldFlagsStatic);
}
...
{
    _states = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[50/*Uno.Collections.List<Fuse.Triggers.Transition>*/]));
    _parent = parent;
    _navigator = navigator;
    uPtr(_navigator)->add_Switched(uDelegate::New(::TYPES[51/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}
...
{
    uPtr(_navigator)->remove_Switched(uDelegate::New(::TYPES[51/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    {
        nav = uAs< ::g::Fuse::Controls::Navigator*>(q, ::TYPES[52/*Fuse.Controls.Navigator*/]);
        q = uPtr(q)->ContextParent();
    }

    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Transition ...*/], t, ::STRINGS[47/*"/usr/local/...*/], 2782, ::STRINGS[48/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Transition ...*/], t, ::STRINGS[47/*"/usr/local/...*/], 2789, ::STRINGS[48/*"Root"*/], NULL);
        return NULL;
    }
...
{
    Trigger::ProgressName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[35/*"Progress"*/]);
}

static void Trigger_build(uType* type)
{
    ::STRINGS[35] = uString::Const("Progress");
    ::STRINGS[50] = uString::Const("Trigger.OnPlaybackdone called with _animState == null");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
    ::STRINGS[51] = uString::Const("Fuse.Animations.IBasePlayerFeedback.OnPlaybackDone");
    ::STRINGS[52] = uString::Const("Trigger started prior to being rooted: ");
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[45] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[53] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Actions::TriggerAction_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(19,
        ::TYPES[53/*Uno.Collections.List<Fuse.Triggers.Actions.TriggerAction>*/], offsetof(::g::Fuse::Triggers::Trigger, _actions), 0,
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/usr/local/...*/], 2879, ::STRINGS[51/*"Fuse.Animat...*/]);
        return;
    }
...
{
    if (_actions == NULL)
        _actions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[53/*Uno.Collections.List<Fuse.Triggers.Actions.TriggerAction>*/]));
...
void Trigger::EnsureAnimationLength()
{
    ...
    n->Delay(actFore);
    n->DelayBack(actBack);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[45/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), n);

    if (HasBackwardAnimation())
    {
        n = ::g::Fuse::Animations::Nothing::New2();
        n->Delay(actBack);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(BackwardAnimation())->Animators()), ::TYPES[45/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), n);
    }
}
...
void Trigger::Start()
{
    ...
    {
        if (!IsRootingStarted())
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[52/*"Trigger sta...*/], this)));
...
bool WhileCompleted::IsCompleted(::g::Fuse::Visual* n)
{
    ...
    if (!uIs(v, ::TYPES[54/*bool*/]))
        return false;

    return uUnbox<bool>(::TYPES[54/*bool*/], v);
}
...
void WhileCompleted::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhileCompleted::_whileCompletedProp(), uBox(::TYPES[54/*bool*/], paused));
...
{
    ::TYPES[55] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[56] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Fuse::Platform::SystemUIWillResizeEventArgs_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::Platform::SystemUI::add_BottomFrameWillResize(uDelegate::New(::TYPES[56/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
...
{
    ::g::Fuse::Platform::SystemUI::remove_BottomFrameWillResize(uDelegate::New(::TYPES[56/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
void WhileKeyboardVisible::OnBottomBarResize(uObject* sender, ::g::Fuse::Platform::SystemUIWillResizeEventArgs* args)
{
    ...
    if (vp != NULL)
        density = ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(vp), ::TYPES[55/*Fuse.ICommonViewport*/]));
...
void WhilePaused::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePaused::_whilePausedProp(), uBox(::TYPES[54/*bool*/], paused));
...
void WhilePlaying::SetState(::g::Fuse::Visual* n, bool playing)
{
    ...
    if (v != playing)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePlaying::_whilePlayingProp(), uBox(::TYPES[54/*bool*/], playing));
...
static void WhileValue_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.2.1/$.uno");
    ::STRINGS[54] = uString::Const("Pulse");
    ::TYPES[57] = ::g::Fuse::Triggers::IValue_typeof();
    ::TYPES[58] = ::g::Uno::UX::ValueChangedHandler_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(33,
        ...
        ::TYPES[57/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _obj), 0,
        ::TYPES[57/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _source), 0,
        type->T(0), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[58/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, ValueChanged1), 0);
}
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[53/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/usr/local/...*/], 4249, ::STRINGS[54/*"Pulse"*/]);
