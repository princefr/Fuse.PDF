...
static void SpringFunction__Subscription_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[10/*Fuse.Reactive.IListener*/], offsetof(::g::Fuse::Motion::SpringFunction__Subscription, _listener), 0,
        ::g::Fuse::Motion::SpringFunction_typeof(), offsetof(::g::Fuse::Motion::SpringFunction__Subscription, _sf), 0,
        ::TYPES[8/*Fuse.Motion.Simulation.ElasticForce<float4>*/], offsetof(::g::Fuse::Motion::SpringFunction__Subscription, _sim), 0,
