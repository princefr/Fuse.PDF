...
// internal abstract extern class Shape :1734
// {
...
// protected Shape() :1736
void Shape__ctor_4_fn(Shape* __this)
{
    __this->ctor_4();
}

// private static ObjC.Object Create() :1951
void Shape__Create_fn(::g::ObjC::Object** __retval)
{
    *__retval = Shape::Create();
}

// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :1746
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) :1935
void Shape__MakeLayers_fn(::g::ObjC::Object* handle, int* layerCount)
{
    Shape::MakeLayers(handle, *layerCount);
}

// protected internal override sealed void OnPositionChanged() :1738
void Shape__OnPositionChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// protected void OnShapeChanged() :1753
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// protected internal override sealed void OnSizeChanged() :1739
void Shape__OnSizeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :1805
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) :1781
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) :1913
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) :1810
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) :1842
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :1781
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, ::g::ObjC::Object* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/usr/local/...*/], 1798, ::STRINGS[2/*"SetBrush"*/]);
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :1810
...
// protected float2 get_ShapePosition() [instance] :1741
::g::Uno::Float2 Shape::ShapePosition()
{
    return ::g::Uno::Float2__New1(0.0f);
}

// protected float2 get_ShapeSize() [instance] :1742
::g::Uno::Float2 Shape::ShapeSize()
{
    return Size();
}

// private static ObjC.Object Create() [static] :1951
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) [static] :1935
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :1805
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) [static] :1913
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) [static] :1842
