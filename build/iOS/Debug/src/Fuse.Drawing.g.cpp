...
static void LinearGradient_build(uType* type)
{
    ...
    ::TYPES[19] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    type->SetInterfaces(
...
{
    uArray* ind4 = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[19/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.GradientStop>*/], (uObject*)_stops);
...
static void LinearGradientDrawable_build(uType* type)
{
    ...
    ::TYPES[21] = ::g::Uno::Float_typeof()->Array();
    ::TYPES[1] = ::g::Uno::Float2_typeof()->Array();
    type->SetFields(0,
...
{
    LinearGradientDrawable_typeof()->Init();
    uArray* ofs = uArray::New(::TYPES[21/*float[]*/], ::g::Uno::Math::Max8(Offsets_1_5_1, 1));
...
static void Surface_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Fuse::IRenderViewport_typeof();
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    if (elm != drawable)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[44/*"GLDraw call...*/], this, ::STRINGS[5/*"/usr/local/...*/], 3026, ::STRINGS[45/*"Draw"*/]);
    ...
    _draw_7678ae3a.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[25/*Fuse.IRenderViewport*/])));
...
static void SurfaceManager_build(uType* type)
{
    ...
    ::TYPES[26] = ::g::Fuse::Drawing::ISurfaceDrawable_typeof();
    type->SetFields(0,
        ::TYPES[27/*Uno.Collections.Dictionary<object, Fuse.Drawing.Surface>*/], (uintptr_t)&::g::Fuse::Drawing::SurfaceManager::_owners_, uFieldFlagsStatic);
}
