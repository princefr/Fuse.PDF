...
{
    FuseDrawingSurface_bundle::CoreGraphicsDrawHelpere074f602_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[116/*"attribute v...*/], ::STRINGS[117/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[4/*"a"*/], ::STRINGS[3/*"c"*/]));
...
static void FuseEffects_bundle__cctor__fn(uType* __type)
{
    ...
    FuseEffects_bundle::Desaturate88bb7f94_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform mat...*/], ::STRINGS[120/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[7/*"f"*/]));
...
{
    FuseReactiveJavaScript_bundle::Diagnostics3be36552_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[145/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[146/*"diagnostics...*/]);
    FuseReactiveJavaScript_bundle::es6promisemin8af4f747_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[145/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[147/*"es6-promise...*/]);
    FuseReactiveJavaScript_bundle::Observable9fb7466f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[145/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[148/*"observable-...*/]);
    FuseReactiveJavaScript_bundle::setTimeout1593941f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[145/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[149/*"settimeout-...*/]);
}
