...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* pdf_FuseControlsWebView_Url_Property_typeof();}
...
namespace g{namespace Uno{namespace Threading{struct Future_type;}} namespace PDF{::g::Uno::Threading::Future_type* LaunchScan_typeof();}}
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace PDF{::g::Fuse::Scripting::NativeModule_type* PDFmodule_typeof();}}
namespace g{namespace Uno{namespace Threading{struct Future_type;}} namespace PDF{::g::Uno::Threading::Future_type* PDFToBase64_typeof();}}
namespace g{namespace Uno{namespace Threading{struct Future_type;}} namespace PDF{::g::Uno::Threading::Future_type* Transform_typeof();}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::pdf_FuseControlsWebView_Url_Property_typeof,
        ...
        (uType*(*)())&::g::PDF::LaunchScan_typeof,
        (uType*(*)())&::g::PDF::PDFmodule_typeof,
        (uType*(*)())&::g::PDF::PDFToBase64_typeof,
        (uType*(*)())&::g::PDF::Transform_typeof,
        NULL
    };
