...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.2.1/$.uno
// --------------------------------------------------------
...
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    ...
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(uPtr(_newArray)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 1, uBox<int>(::TYPES[46/*int*/], uPtr(values)->Length()))), ::TYPES[11/*Fuse.Scripting.Array*/]);
...
static void Module_build(uType* type)
{
    ...
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[22] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    {
        if (uIs(__t.Exception, ::TYPES[22/*Fuse.Scripting.ScriptException*/]))
        {
...
static void ModuleResult_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[23/*Uno.Collections.List<Uno.Action>*/], offsetof(::g::Fuse::Scripting::ModuleResult, _invalidateCallbacks), 0,
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.2.1/$.uno");
    ::TYPES[26] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array(), NULL);
    ::TYPES[27] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(1/*Invoke1<object[], object>*/, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[9] = uObject_typeof()->Array();
    ...
    type->SetFields(8,
        ::TYPES[26/*Uno.Collections.Queue<object[]>*/], offsetof(::g::Fuse::Scripting::NativeEvent, _eventArgsQueue), 0,
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[26/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[27/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[28/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}

// internal object RaiseSync(object[] args) [instance] :897
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[23/*"this.Contex...*/], ::STRINGS[24/*"/usr/local/...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));

    if (_jsFunction != NULL)
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[27/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[28/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), args);
...
static void NativeEventEmitterModule_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL), NULL);
    ::TYPES[30] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL), NULL);
    ::TYPES[31] = ::g::Uno::EventHandler_typeof();
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[32] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2/*Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/, ::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[33] = ::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[34] = ::g::Uno::Tuple_typeof()->MakeMethod(0/*Create<object, Fuse.Scripting.Callback>*/, uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[2] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[35] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::TYPES[13/*Fuse.Scripting.Callback*/], NULL), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(4,
        ...
        ::TYPES[29/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _listeningCallbacks), 0,
        uObject_typeof(), offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _mutex), 0,
        ::TYPES[30/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _queuedEvents), 0,
...
{
    _listeningCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[29/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/]));
    _mutex = ::g::Uno::Object::New();
    _queuedEvents = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[30/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/]));
    ctor_1();
    _queueEventsBeforeInit = queueEventsBeforeInit;
    _eventNames = eventNames;
    add_Reset(uDelegate::New(::TYPES[31/*Uno.EventHandler*/], (void*)NativeEventEmitterModule__ResetListeners_fn, this));
}
...
void NativeEventEmitterModule::Dispatch(uDelegate* action, bool alwaysQueueEventBeforeInit)
{
    ...
    ::g::Uno::Threading::IDispatcherExtensions__Invoke2_fn(::TYPES[32/*Uno.Threading.IDispatcherExtensions.Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], uPtr(_context)->Dispatcher(), action, _context, _this);
}

// protected void Emit(object[] args) [instance] :991
void NativeEventEmitterModule::Emit(uArray* args)
{
    Dispatch(uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__EmitClosure__Emit_fn, NativeEventEmitterModule__EmitClosure::New1(args)), false);
}
...
void NativeEventEmitterModule::On(uObject* eventName, uDelegate* listener)
{
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::List__Add_fn(uPtr(_listeningCallbacks), (::g::Uno::Tuple__Create1_fn(::TYPES[34/*Uno.Tuple.Create<object, Fuse.Scripting.Callback>*/], eventName, listener, &ret4), ret4));
    }

    Dispatch(uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1(eventName, listener)), true);
}
...
void NativeEventEmitterModule::ResetListenersJS()
{
...

    {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Tuple2*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_listeningCallbacks), &ret6), ret6); enum1.MoveNext(::TYPES[35/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]); )
        {
            ::g::Uno::Tuple2* l = enum1.Current(::TYPES[35/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]);
            Dispatch(uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1((::g::Uno::Tuple2__get_Item1_fn(uPtr(l), &ret7), ret7), (::g::Uno::Tuple2__get_Item2_fn(uPtr(l), &ret8), ret8))), true);
        }
    }
...
static void NativeModule_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("exports");
    ::TYPES[36] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[12] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[37] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ::TYPES[36/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/], offsetof(::g::Fuse::Scripting::NativeModule, _members), 0,
        ::TYPES[31/*Uno.EventHandler*/], offsetof(::g::Fuse::Scripting::NativeModule, Reset1), 0);
}
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (module != NULL)
    {
        ...
        if (obj != NULL)
            ...
            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[37/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
            {
                ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[37/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
                uPtr(m)->Create(obj, c);
            }
    }
}
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[36/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
{
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Reset1, value), ::TYPES[31/*Uno.EventHandler*/]);
}

// public generated void remove_Reset(Uno.EventHandler value) [instance] :1232
void NativeModule::remove_Reset(uDelegate* value)
{
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Reset1, value), ::TYPES[31/*Uno.EventHandler*/]);
}
// }
...
{
    ::TYPES[38] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[39] = NativePromise__ContextClosure_typeof();
    ::TYPES[40] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[41] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[42] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(3,
        ...
        ::TYPES[38/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativePromise, _futureFactory), 0,
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[41/*Uno.Threading.ThreadStart*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[1], _func, args, future)))->Start();
    return future;
}
...
{
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[43] = ::g::Uno::Func_typeof();
    ::TYPES[44] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
        type->T(1),
        type->T(0),
    ...
    type->SetFields(3,
        ::TYPES[43/*Uno.Func`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _getHandler), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::NativeProperty, _isReadonly), 0,
        type->T(1), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[44/*Uno.Action`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _setHandler), 0,
...
{
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[45] = ::g::Uno::Short_typeof();
    ::TYPES[46] = ::g::Uno::Int_typeof();
    ::TYPES[47] = ::g::Uno::Long_typeof();
    ::TYPES[48] = ::g::Uno::Float_typeof();
    ::TYPES[49] = ::g::Uno::Double_typeof();
    ::TYPES[15] = ::g::Uno::Exception_typeof();
    type->MethodTypes[1]->SetPrecalc(
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[45/*short*/]))
        return uBox<int16_t>(::TYPES[45/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[46/*int*/]))
        return uBox<int>(::TYPES[46/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[47/*long*/]))
        return uBox<int64_t>(::TYPES[47/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[48/*float*/]))
        return uBox(::TYPES[48/*float*/], (float)value);

    return uBox(::TYPES[49/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[49/*double*/]))
        return uBox(::TYPES[49/*double*/], (double)value);

    return uBox(::TYPES[48/*float*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert2(int value, uType* targetType)
{
    ...
    return uBox<int>(::TYPES[46/*int*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[47/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[45/*short*/], value);
}
...
{
    if (uIs(value, ::TYPES[45/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[45/*short*/], value), targetType);

    if (uIs(value, ::TYPES[46/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[46/*int*/], value), targetType);

    if (uIs(value, ::TYPES[47/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[47/*long*/], value), targetType);

    if (uIs(value, ::TYPES[48/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[48/*float*/], value), targetType);

    if (uIs(value, ::TYPES[49/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[49/*double*/], value), targetType);
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[44] = ::g::Uno::Action1_typeof();
    ::TYPES[50] = ::TYPES[44/*Uno.Action`1*/]->MakeType(::g::Uno::Exception_typeof(), NULL);
    type->SetPrecalc(
        type->T(1),
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[50/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[51/*string*/], (uintptr_t)&::g::Fuse::Scripting::ScriptModule__RequireContext::_lastErrorPath_, uFieldFlagsStatic);
}
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[28/*"require(): ...*/], uBox<int>(::TYPES[46/*int*/], uPtr(args)->Length())), ::STRINGS[29/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[51/*string*/]);
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], path), ::STRINGS[33/*" was fixed!"*/]), this, ::STRINGS[24/*"/usr/local/...*/], 1879, ::STRINGS[34/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], path), ::STRINGS[35/*" line "*/]), uBox<int>(::TYPES[46/*int*/], uPtr(e)->LineNumber())), ::STRINGS[36/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[24/*"/usr/local/...*/], 1889, ::STRINGS[34/*"Require"*/], NULL);
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[52/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[52] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), type, NULL);
    type->SetFields(0,
        ...
        ::TYPES[52/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/], (uintptr_t)&::g::Fuse::Scripting::ScriptClass::_unoTypeToScriptClass_, uFieldFlagsStatic);
}
...
static void ScriptException_build(uType* type)
{
    ...
    type->SetFields(4,
        ...
        ::TYPES[46/*int*/], offsetof(::g::Fuse::Scripting::ScriptException, _LineNumber), 0,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    if (__this->LineNumber() >= 0)
    {
        ...
        stringBuilder->AppendLine(::g::Uno::Int::ToString(__this->LineNumber(), ::TYPES[46/*int*/]));
    }
...
static void ScriptMethod1_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[53] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[43/*"Cannot call...*/], __this, ::STRINGS[24/*"/usr/local/...*/], 1582, ::STRINGS[44/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
static void ScriptModule_build(uType* type)
{
    ...
    ::TYPES[54] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[55] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[56] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[57] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[58] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[59] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uArray* newlines = uArray::New(::TYPES[55/*char[]*/], offset);

    for (int i = 0; i < offset; ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[56/*Uno.Collections.List<object>*/]);
...
{
    return uIs(obj, ::TYPES[54/*Fuse.Scripting.IModuleProvider*/]);
}
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[46/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[46/*".js"*/], ::STRINGS[9/*""*/]);
...
uString* ScriptModule::GetSourcePath()
{
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[55/*char[]*/], 1, '/'));
    else
        return ::STRINGS[9/*""*/];
}
...
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    ...
    if (Bundle() != NULL)
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[57/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[58/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[59/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (ScriptModule::IsPathEqual(uPtr(f)->SourcePath(), path))
                return f;
        }

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[57/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[58/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[59/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret5), ret5);
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[60/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[54/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[55/*char[]*/], 1, '/'));
...
{
    if (uIs(obj, ::TYPES[49/*double*/]))
        return uUnbox<double>(::TYPES[49/*double*/], obj);

    if (uIs(obj, ::TYPES[48/*float*/]))
        return (double)uUnbox<float>(::TYPES[48/*float*/], obj);

    if (uIs(obj, ::TYPES[46/*int*/]))
        return (double)uUnbox<int>(::TYPES[46/*int*/], obj);

    if (uIs(obj, ::TYPES[62/*uint*/]))
        return (double)uUnbox<uint32_t>(::TYPES[62/*uint*/], obj);
