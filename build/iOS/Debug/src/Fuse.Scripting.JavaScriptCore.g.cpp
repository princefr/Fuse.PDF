...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/1.2.1/$.uno
// -----------------------------------------------------------------------
...
// public override sealed bool Equals(Fuse.Scripting.Array a) :58
...
// public override sealed object get_Item(int index) :29
...
// public override sealed void set_Item(int index, object value) :36
...
// public override sealed int get_Length() :47
...
// public CallbackWrapper(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.Callback callback) :363
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef Call(Fuse.Scripting.JavaScriptCore.JSValueRef[] args, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :369
...
// public CallbackWrapper New(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.Callback callback) :363
...
// public CallbackWrapper(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.Callback callback) [instance] :363
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef Call(Fuse.Scripting.JavaScriptCore.JSValueRef[] args, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :369
...
// public CallbackWrapper New(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.Callback callback) [static] :363
...
// public Context(Fuse.Scripting.IThreadWorker worker) :95
...
// public override sealed object Evaluate(string fileName, string code) :146
...
// private void OnError(Fuse.Scripting.JavaScriptCore.JSValueRef exception) [instance] :178
...
// private void OnSetupError(Fuse.Scripting.JavaScriptCore.JSValueRef exception) [instance] :171
...
// internal Fuse.Scripting.JavaScriptCore.JSValueRef Unwrap(object obj) [instance] :246
...
// internal Fuse.Scripting.JavaScriptCore.JSValueRef[] Unwrap(object[] obj) [instance] :272
...
// private Fuse.Scripting.JavaScriptCore.JSValueRef UnwrapArrayBuffer(byte[] data) [instance] :284
...
// internal object Wrap(Fuse.Scripting.JavaScriptCore.JSValueRef value) [instance] :211
...
// internal object[] Wrap(Fuse.Scripting.JavaScriptCore.JSValueRef[] values) [instance] :236
...
// private byte[] WrapArrayBuffer(Fuse.Scripting.JavaScriptCore.JSObjectRef value) [instance] :315
...
// public Context New(Fuse.Scripting.IThreadWorker worker) [static] :95
...
// private static void OnSetupErrorError(Fuse.Scripting.JavaScriptCore.JSValueRef exception) [static] :166
...
// internal Function(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef function) :399
...
// public override sealed object Call(object[] args) :412
...
// public override sealed Fuse.Scripting.Object Construct(object[] args) :422
...
// public override sealed bool Equals(Fuse.Scripting.Function f) :431
...
// public override sealed int GetHashCode() :436
...
// internal Function New(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef function) :399
...
// internal Function(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef function) [instance] :399
...
// internal Function New(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef function) [static] :399
...
// {
// public void Dispose() [adapter] :933
...
// public static Fuse.Scripting.JavaScriptCore.JSClassRef CreateUnoFinalizer() [static] :863
...
// {
// public void Dispose() [adapter] :805
...
{
    ::STRINGS[21] = uString::Const("script");
    ::STRINGS[10] = uString::Const("sourceURL");
...
// public static Fuse.Scripting.JavaScriptCore.JSContextRef Create() :800
...
// private Fuse.Scripting.JavaScriptCore.JSValueRef EvaluateScript(Fuse.Scripting.JavaScriptCore.JSStringRef script, Fuse.Scripting.JavaScriptCore.JSObjectRef thisObject, Fuse.Scripting.JavaScriptCore.JSStringRef sourceURL, int startingLineNumber, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :818
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef EvaluateScript(string script, Fuse.Scripting.JavaScriptCore.JSObjectRef thisObject, string sourceURL, int startingLineNumber, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :828
...
// public Fuse.Scripting.JavaScriptCore.JSObjectRef get_GlobalObject() :812
...
// private Fuse.Scripting.JavaScriptCore.JSValueRef EvaluateScript(Fuse.Scripting.JavaScriptCore.JSStringRef script, Fuse.Scripting.JavaScriptCore.JSObjectRef thisObject, Fuse.Scripting.JavaScriptCore.JSStringRef sourceURL, int startingLineNumber, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :818
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef EvaluateScript(string script, Fuse.Scripting.JavaScriptCore.JSObjectRef thisObject, string sourceURL, int startingLineNumber, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :828
::JSValueRef JSContextRef::EvaluateScript1(::JSContextRef __this, uString* script, ::JSObjectRef thisObject, uString* sourceURL, int startingLineNumber, uDelegate* onException)
{
    if (::g::Uno::String::op_Equality(script, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[21/*"script"*/]));

    if (::g::Uno::String::op_Equality(sourceURL, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[10/*"sourceURL"*/]));
...
// public Fuse.Scripting.JavaScriptCore.JSObjectRef get_GlobalObject() [instance] :812
::JSObjectRef JSContextRef::GlobalObject(::JSContextRef __this)
{
    return ::JSContextGetGlobalObject(*&__this);
}

// public static Fuse.Scripting.JavaScriptCore.JSContextRef Create() [static] :800
...
{
    ::STRINGS[22] = uString::Const("propertyName");
    ::TYPES[18] = ::g::Uno::IDisposable_typeof();
    type->SetFields(0,
...
// public Fuse.Scripting.JavaScriptCore.JSObjectRef CallAsConstructor(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSValueRef[] arguments, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :746
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef CallAsFunction(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSObjectRef thisObject, Fuse.Scripting.JavaScriptCore.JSValueRef[] arguments, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :727
...
// public Fuse.Scripting.JavaScriptCore.JSPropertyNameArray CopyPropertyNames(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :716
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef GetJSValueRef() :696
void JSObjectRef__GetJSValueRef_fn(::JSObjectRef* __this, ::JSValueRef* __retval)
{
    *__retval = JSObjectRef::GetJSValueRef(*__this);
}

// public object GetPrivate() :701
void JSObjectRef__GetPrivate_fn(::JSObjectRef* __this, uObject** __retval)
{
    *__retval = JSObjectRef::GetPrivate(*__this);
}

// private Fuse.Scripting.JavaScriptCore.JSValueRef GetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef propertyName, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :620
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef GetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string propertyName, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :625
...
// private Fuse.Scripting.JavaScriptCore.JSValueRef GetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :655
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef GetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :660
...
// public bool HasProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef propertyName) :682
...
// public bool HasProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string propertyName) :687
...
// public static Fuse.Scripting.JavaScriptCore.JSObjectRef Make(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, [Fuse.Scripting.JavaScriptCore.JSClassRef classRef], [object data]) :721
...
// public static operator !=(Fuse.Scripting.JavaScriptCore.JSObjectRef o1, Fuse.Scripting.JavaScriptCore.JSObjectRef o2) :618
void JSObjectRef__op_Inequality_fn(::JSObjectRef* o1, ::JSObjectRef* o2, bool* __retval)
{
    *__retval = JSObjectRef::op_Inequality(*o1, *o2);
}

// private void SetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef propertyName, Fuse.Scripting.JavaScriptCore.JSValueRef value, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :638
...
// public void SetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string propertyName, Fuse.Scripting.JavaScriptCore.JSValueRef value, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :643
...
// private void SetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Fuse.Scripting.JavaScriptCore.JSValueRef value, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :669
...
// public void SetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Fuse.Scripting.JavaScriptCore.JSValueRef value, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :674
...
// public void SetPrototype(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSValueRef value) :711
...
// public Fuse.Scripting.JavaScriptCore.JSObjectRef CallAsConstructor(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSValueRef[] arguments, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :746
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef CallAsFunction(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSObjectRef thisObject, Fuse.Scripting.JavaScriptCore.JSValueRef[] arguments, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :727
...
// public Fuse.Scripting.JavaScriptCore.JSPropertyNameArray CopyPropertyNames(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :716
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef GetJSValueRef() [instance] :696
::JSValueRef JSObjectRef::GetJSValueRef(::JSObjectRef __this)
{
    return (::JSValueRef)*&__this;
}

// public object GetPrivate() [instance] :701
uObject* JSObjectRef::GetPrivate(::JSObjectRef __this)
{
    return (uObject*)::JSObjectGetPrivate(*&__this);
}

// private Fuse.Scripting.JavaScriptCore.JSValueRef GetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef propertyName, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :620
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef GetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string propertyName, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :625
::JSValueRef JSObjectRef::GetProperty1(::JSObjectRef __this, ::JSContextRef ctx, uString* propertyName, uDelegate* onException)
{
    if (::g::Uno::String::op_Equality(propertyName, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[22/*"propertyName"*/]));
...
// private Fuse.Scripting.JavaScriptCore.JSValueRef GetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :655
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef GetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :660
...
// public bool HasProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef propertyName) [instance] :682
...
// public bool HasProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string propertyName) [instance] :687
...
// private void SetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef propertyName, Fuse.Scripting.JavaScriptCore.JSValueRef value, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :638
...
// public void SetProperty(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string propertyName, Fuse.Scripting.JavaScriptCore.JSValueRef value, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :643
...
// private void SetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Fuse.Scripting.JavaScriptCore.JSValueRef value, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :669
...
// public void SetPropertyAtIndex(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, int index, Fuse.Scripting.JavaScriptCore.JSValueRef value, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :674
...
// public void SetPrototype(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSValueRef value) [instance] :711
void JSObjectRef::SetPrototype(::JSObjectRef __this, ::JSContextRef ctx, ::JSValueRef value)
{
    ::JSObjectSetPrototype(ctx, *&__this, value);
}

// public static Fuse.Scripting.JavaScriptCore.JSObjectRef Make(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, [Fuse.Scripting.JavaScriptCore.JSClassRef classRef], [object data]) [static] :721
...
// public static operator !=(Fuse.Scripting.JavaScriptCore.JSObjectRef o1, Fuse.Scripting.JavaScriptCore.JSObjectRef o2) [static] :618
...
// {
// public void Dispose() [adapter] :785
...
// public Fuse.Scripting.JavaScriptCore.JSStringRef get_Item(int index) :779
...
// {
// public void Dispose() [adapter] :595
...
// public void Dispose() [instance] :595
void JSStringRef::Dispose(::JSStringRef __this)
{
    ::JSStringRelease(*&__this);
}

// public static Fuse.Scripting.JavaScriptCore.JSStringRef Create(string str) [static] :590
...
// public static byte[] TryCopyArrayBufferBytes(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSObjectRef obj, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :970
...
// public static Fuse.Scripting.JavaScriptCore.JSObjectRef TryMakeArrayBufferWithBytes(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, byte[] bytes, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :943
...
// public static byte[] TryCopyArrayBufferBytes(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSObjectRef obj, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [static] :970
...
// public static Fuse.Scripting.JavaScriptCore.JSObjectRef TryMakeArrayBufferWithBytes(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, byte[] bytes, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [static] :943
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/1.2.1/$.uno");
...
// public Fuse.Scripting.JavaScriptCore.JSObjectRef GetJSObjectRef(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :474
...
// public Fuse.Scripting.JavaScriptCore.JSType GetType(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :482
void JSValueRef__GetType1_fn(::JSValueRef* __this, ::JSContextRef* ctx, int* __retval)
{
    *__retval = JSValueRef::GetType1(*__this, *ctx);
}

// public bool IsInstanceOfConstructor(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSObjectRef constructor, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :518
...
// public bool IsObject(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :513
void JSValueRef__IsObject_fn(::JSValueRef* __this, ::JSContextRef* ctx, bool* __retval)
{
    *__retval = JSValueRef::IsObject(*__this, *ctx);
}

// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeBoolean(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, bool boolean) :551
...
// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeNull(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :541
void JSValueRef__MakeNull_fn(::JSContextRef* ctx, ::JSValueRef* __retval)
{
    *__retval = JSValueRef::MakeNull(*ctx);
}

// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeNumber(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, double number) :546
...
// private static Fuse.Scripting.JavaScriptCore.JSValueRef MakeString(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef str) :527
...
// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeString(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string str) :532
void JSValueRef__MakeString1_fn(::JSContextRef* ctx, uString* str, ::JSValueRef* __retval)
{
    *__retval = JSValueRef::MakeString1(*ctx, str);
}

// public static operator !=(Fuse.Scripting.JavaScriptCore.JSValueRef v1, Fuse.Scripting.JavaScriptCore.JSValueRef v2) :460
void JSValueRef__op_Inequality_fn(::JSValueRef* v1, ::JSValueRef* v2, bool* __retval)
{
    *__retval = JSValueRef::op_Inequality(*v1, *v2);
}

// public void Protect(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :463
void JSValueRef__Protect_fn(::JSValueRef* __this, ::JSContextRef* ctx)
{
    JSValueRef::Protect(*__this, *ctx);
}

// public bool ToBoolean(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :556
void JSValueRef__ToBoolean_fn(::JSValueRef* __this, ::JSContextRef* ctx, bool* __retval)
{
    *__retval = JSValueRef::ToBoolean(*__this, *ctx);
}

// public double ToNumber(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :561
...
// public string ToString(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) :502
...
// private Fuse.Scripting.JavaScriptCore.JSStringRef ToStringCopy(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) :497
...
// public void Unprotect(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) :469
void JSValueRef__Unprotect_fn(::JSValueRef* __this, ::JSContextRef* ctx)
{
    JSValueRef::Unprotect(*__this, *ctx);
}

// public Fuse.Scripting.JavaScriptCore.JSObjectRef GetJSObjectRef(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :474
::JSObjectRef JSValueRef::GetJSObjectRef(::JSValueRef __this, ::JSContextRef ctx)
{
    ::g::Uno::Diagnostics::Debug::Assert(JSValueRef::IsObject(__this, ctx), ::STRINGS[23/*"(&this).IsO...*/], ::STRINGS[24/*"/usr/local/...*/], 476, uArray::Init<uObject*>(::TYPES[16/*object[]*/], 1, uBox(::g::Fuse::Scripting::JavaScriptCore::JSContextRef_typeof(), ctx)));
    return (::JSObjectRef)*&__this;
}

// public Fuse.Scripting.JavaScriptCore.JSType GetType(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :482
...
// public bool IsInstanceOfConstructor(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSObjectRef constructor, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :518
...
// public bool IsObject(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :513
bool JSValueRef::IsObject(::JSValueRef __this, ::JSContextRef ctx)
{
    return ::JSValueIsObject(ctx, *&__this);
}

// public void Protect(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :463
void JSValueRef::Protect(::JSValueRef __this, ::JSContextRef ctx)
{
    ::JSValueProtect(ctx, *&__this);
}

// public bool ToBoolean(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :556
bool JSValueRef::ToBoolean(::JSValueRef __this, ::JSContextRef ctx)
{
    return ::JSValueToBoolean(ctx, *&__this);
}

// public double ToNumber(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :561
...
// public string ToString(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Uno.Action<Fuse.Scripting.JavaScriptCore.JSValueRef> onException) [instance] :502
...
// private Fuse.Scripting.JavaScriptCore.JSStringRef ToStringCopy(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSValueRef& exception) [instance] :497
...
// public void Unprotect(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [instance] :469
void JSValueRef::Unprotect(::JSValueRef __this, ::JSContextRef ctx)
{
    ::JSValueUnprotect(ctx, *&__this);
}

// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeBoolean(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, bool boolean) [static] :551
::JSValueRef JSValueRef::MakeBoolean(::JSContextRef ctx, bool boolean)
{
    return ::JSValueMakeBoolean(ctx, boolean);
}

// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeNull(Fuse.Scripting.JavaScriptCore.JSContextRef ctx) [static] :541
::JSValueRef JSValueRef::MakeNull(::JSContextRef ctx)
{
    return ::JSValueMakeNull(ctx);
}

// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeNumber(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, double number) [static] :546
::JSValueRef JSValueRef::MakeNumber(::JSContextRef ctx, double number)
{
    return ::JSValueMakeNumber(ctx, number);
}

// private static Fuse.Scripting.JavaScriptCore.JSValueRef MakeString(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, Fuse.Scripting.JavaScriptCore.JSStringRef str) [static] :527
::JSValueRef JSValueRef::MakeString(::JSContextRef ctx, ::JSStringRef str)
{
    return ::JSValueMakeString(ctx, str);
}

// public static Fuse.Scripting.JavaScriptCore.JSValueRef MakeString(Fuse.Scripting.JavaScriptCore.JSContextRef ctx, string str) [static] :532
...
// public static operator !=(Fuse.Scripting.JavaScriptCore.JSValueRef v1, Fuse.Scripting.JavaScriptCore.JSValueRef v2) [static] :460
...
{
    ::STRINGS[26] = uString::Const("Object.CallMethod.name");
    ::TYPES[11] = ::g::Fuse::Scripting::JavaScriptCore::Function_typeof();
...
// internal Object(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef value) :1008
...
// public override sealed object CallMethod(string name, object[] args) :1066
void Object__CallMethod_fn(Object* __this, uString* name, uArray* args, uObject** __retval)
{
    ::JSObjectRef ind7;

    if (::g::Uno::String::op_Equality(name, NULL))
        U_THROW(::g::Uno::ArgumentException::New4(::STRINGS[26/*"Object.Call...*/]));
...
// public override sealed bool ContainsKey(string key) :1081
...
// public override sealed bool Equals(Fuse.Scripting.Object o) :1086
...
// public override sealed int GetHashCode() :1091
...
// public override sealed bool InstanceOf(Fuse.Scripting.Function type) :1057
...
// public override sealed object get_Item(string key) :1023
...
// public override sealed void set_Item(string key, object value) :1030
...
// public override sealed string[] get_Keys() :1042
...
// internal Object New(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef value) :1008
...
// internal Object(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef value) [instance] :1008
...
// internal Object New(Fuse.Scripting.JavaScriptCore.Context context, Fuse.Scripting.JavaScriptCore.JSObjectRef value) [static] :1008
